...
public class BrightFreshMilkGUI extends JPanel {
	...
	class DisplaySalesListener implements ActionListener {
		 ...
		 */
		public void actionPerformed(ActionEvent event) {
			if (BrightFreshMilkGUI.this.sales.getOrderList().size() == 0){
		        BrightFreshMilkGUI.this.statusTextArea.setText("No orders have been sold!");
			}else{
			BrightFreshMilkGUI.this.statusTextArea.setText
				(BrightFreshMilkGUI.this.salesFormatter.formateSales(BrightFreshMilkGUI.this.sales));
			}
			 ...
			 if (BrightFreshMilkGUI.this.sales.getOrderList().size() == 0) {
		          BrightFreshMilkGUI.this.statusTextArea.setText("No orders have been sold!");
		        	...
		        	try {
		        		...
		        		save.print(BrightFreshMilkGUI.this.salesFormatter.formateSales(BrightFreshMilkGUI.this.sales));
		        		save.close();
		        		BrightFreshMilkGUI.this.statusTextArea.setText("Success!");
		        	} catch (IOException e) {
		        		e.printStackTrace();
		        		BrightFreshMilkGUI.this.statusTextArea.setText("Problem with I/O");
		        	}
			/* PLACE YOUR CODE HERE */
			// to do
		        }
