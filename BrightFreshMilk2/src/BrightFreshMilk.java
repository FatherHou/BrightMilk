...
public class BrightFreshMilk {
	...
	private void loadSales(Catalog catalog) {
		...
		List<CurrentOrder> orderList = new ArrayList<>();
		...
		List<OrderItem> orderItemListTwo = new ArrayList<>();
		...
		List<OrderItem> orderItemListThree = new ArrayList<>();
	...
	private void displaySales() {
		stdOut.println(salesFormatter.formateSales(sales));
		// to do
	}
